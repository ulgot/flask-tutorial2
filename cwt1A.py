...
<p class=heading>Jaki jest cel projektu?</p>
...
<br />
<p class=heading>Dla kogo jest skierowany?</p>
<p>Projekt jest skierowany do studentów którzy programują lub znają podstawy w zakresie
programowania.</p>
<br />
<p class=heading>Jaki będzie efekt końcowy?</p>
<p>Powstanie strony internetowej, gdzie studenci łączą się w 3-4 osobowe zespoły, 
a następnie przystępują do kursu który będzie kończył się otrzymaniem certyfikatu 
za ukończenie kursu.</p>
'''
    return msg
